    ...
    <div id="generador">
      ...
      <div id="boton2">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['crearMuroInput'])) {
          $UUID = uniqid("notitas");
          $nuevoMuro = "/php/notas.php?muro=" . $UUID;
          ...
          echo ("
            <script>
              ...
              document.getElementById('boton2').innerHTML = `
                ...
                <button id='downloadBtn' class='btn btn-success btn-lg' style='background: none; border: none; padding: 0; margin-top: 20px;'>
                  <img src='../assets/img/botonDescargar.png' alt='Descargar QR' style='width: 70%; height: auto;'>
                </button>
              `;
      ...
      <div id="contenedorTexto2">
        <h4>Recorda guardar el qr de tu muro</h4>
        <h4>y dejar tu primer mensaje</h4>
      </div>
    </div>
  </div>
