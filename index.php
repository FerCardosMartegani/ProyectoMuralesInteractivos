  ...
  <div class="row">
    <div class="col-sm-6"> <!-- ******************************************************************* -->
      ...
      <div id="contenedorTexto">
        <h3>¿Cómo uso la app?</h3>
        <h4>1- Escanea un QR valido
        </h4>
        <h4>2- Observa lo que otrx escribió
        </h4>
        <h4>3- Deja tu propio mensaje
        </h4>
        <h4>4- ¡Compartilo con quien quieras!
        </h4>
